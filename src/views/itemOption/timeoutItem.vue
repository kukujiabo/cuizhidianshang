  ...
  >
    <el-row>
      <el-col :span="12" style="text-align:center;width:375px;">
        <div v-if="areas.length" id="timesMap" class="area-container">
          ...
          >
            ...
            <span class="cropper-point point-e" data-direct="e" />
            <span class="cropper-point point-n" data-direct="n" />
            <span class="cropper-point point-w" data-direct="w" />
            <span class="cropper-point point-s" data-direct="s" />
            <span class="cropper-point point-ne" data-direct="ne" />
            <span class="cropper-point point-nw" data-direct="nw" />
            <span class="cropper-point point-sw" data-direct="sw" />
            <span class="cropper-point point-se" data-direct="se" />
          </div>
          <div
          ...
          >
            <div class="crop-box-content">
              <span v-if="areas[3].mini" class="crop-box-text" :style="getFontStyle(areas[3])">{{ areas[2].show ? counts.second : counts.all_second }}.{{ counts.millisecond }}</span>
              <span v-else class="crop-box-text" :style="getFontStyle(areas[3])">{{ areas[2].show ? counts.second : counts.all_second }}</span>
            </div>
      ...
      <el-col v-if="areas.length" :span="12" style="width:320px;margin-left:30px;">
        <el-tabs v-model="currentTab" @tab-click="changTimes">
          <el-tab-pane label=" 天数 " name="day">
            <el-form label-width="100px">
              <el-form-item class="small" label="是否显示：">
                <el-switch v-model="areas[0].show" controls-position="left" />
              </el-form-item>
              <el-form-item class="small" label="字体大小：">
                <el-input-number v-model="areas[0].font" size="mini" :min="20" :max="200" />
              </el-form-item>
              ...
              <el-form-item class="small" label="字体颜色：">
                <el-color-picker v-model="areas[0].color" />
              </el-form-item>
            </el-form>
          </el-tab-pane>
          <el-tab-pane label=" 小时 " name="hour">
            <el-form label-width="100px">
              <el-form-item class="small" label="是否显示：">
                <el-switch v-model="areas[1].show" controls-position="left" />
              </el-form-item>
              <el-form-item class="small" label="字体大小：">
                <el-input-number
              ...
              <el-form-item class="small" label="字体颜色：">
                <el-color-picker v-model="areas[1].color" />
              </el-form-item>
            </el-form>
          </el-tab-pane>
          <el-tab-pane label=" 分钟 " name="minute">
            <el-form label-width="100px">
              <el-form-item class="small" label="是否显示：">
                <el-switch v-model="areas[2].show" controls-position="left" />
              </el-form-item>
              <el-form-item class="small" label="字体大小：">
                <el-input-number v-model="areas[2].font" size="mini" :min="20" :max="200" />
              </el-form-item>
              <el-form-item class="small" label="字体粗细：">
              ...
              <el-form-item class="small" label="字体颜色：">
                <el-color-picker v-model="areas[2].color" />
              </el-form-item>
            </el-form>
          </el-tab-pane>
          <el-tab-pane label=" 秒数 " name="second">
            <el-form label-width="100px">
              <el-form-item class="small" label="是否显示：">
                <el-switch v-model="areas[3].show" controls-position="left" />
              </el-form-item>
              <el-form-item class="small" label="字体大小：">
                <el-input-number v-model="areas[3].font" size="mini" :min="20" :max="200" />
              </el-form-item>
              <el-form-item class="small" label="字体粗细：">
              ...
              <el-form-item class="small" label="字体颜色：">
                <el-color-picker v-model="areas[3].color" />
              </el-form-item>
            </el-form>
          </el-tab-pane>
        </el-tabs>

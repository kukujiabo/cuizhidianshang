      ...
      <div>
        ...
        <div class="option-config-container">
          <div class="config-item-container">
            <div v-for="(c, index) in action.config" :key="c.id" class="coupon-itm">
              <p>{{ c.title }}</p>
              <!-- <p>{{}}</p> -->
              <i class="el-icon-remove" @click="removeCoupon(index)" />
            </div>
        ...
        <div class="option-config-container">
          <div class="flex flex-row" style="justify-content:space-between">
            ...
            <span>
              <el-checkbox v-model="action.hideUsed" label="隐藏已抢完优惠券" />
            </span>
          </div>

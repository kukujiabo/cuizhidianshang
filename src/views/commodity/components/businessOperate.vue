      ...
      <div class="inner-form-wrapper">
        <el-form ref="form" :model="form" label-width="120px">
          ...
          <el-form-item prop="joinGroupOfPage" required label="引导方式：">
            <el-checkbox v-model="form.joinGroupOfPage">详情页引导加群</el-checkbox>
          ...
          <el-form-item prop="joinGroupOfPageTitle">
            <div class="inner-line-input">
              ...
              <el-input v-model="form.joinGroupOfPageTitle" style="width:220px;" placeholder="请输入要显示的标题" maxlength="16" show-word-limit />
            </div>
          </el-form-item>
          <el-form-item prop="joinGroupOfBuy">
            <el-checkbox v-model="form.joinGroupOfBuy">购买成功页引导加群</el-checkbox>
          ...
          <el-form-item required prop="qrTitle" label="内容设置：">
            <div class="inner-line-input">
              ...
              <el-input v-model="form.qrTitle" style="width:400px;" placeholder="可输入群名称" maxlength="30" show-word-limit />
            </div>
          </el-form-item>
          <el-form-item prop="qrRemark" label=" ">
            <div class="inner-line-input">
              <span class="inner-line-label" style="width:100px;">二维码描述</span>
              <el-input v-model="form.qrRemark" style="width:400px;" placeholder="可输入相关引导文案" maxlength="40" show-word-limit />
            </div>
          </el-form-item>
          <el-form-item label=" ">
